#==========================================Double Bit-Flip - Semi-permanent - lcAssertive================================
import os
import sys
import optparse
import numpy
...
for j in numpy.arange(11.0, 21.0, 0.5): # Loop for fault injection TIME interval =======================================
    ...
    for i in range(0, 100, 1):  # When you select a number, note that the overall probablity is:"((64*64 - (repetitive numbers like 11 22)) / 2)
        ...
        print("value= ", value)
        if abs(value) == math.inf or str(value) =='nan':   # If the selected value be infinity, it considers it as 99e+1000 since sumo does not accept infinity.
            infinityNum+=1

#==========================================Single Bit-Flip - Semi-permanent - lcOvertakeRight==================================
import os
import sys
import optparse
import numpy
...
for j in numpy.arange(11.0, 21.00, 0.5): # Loop for fault injection TIME interval =======================================
    ...
    for i in range(0, 64, 1): # Loop to define how many times to do bit-flip ===========================================
        ...
        print("value= ", value)
        if value == math.inf:   # If the selected value be infinity, it considers it as 99e+1000 since sumo does not accept inf
            infinityNum+=1

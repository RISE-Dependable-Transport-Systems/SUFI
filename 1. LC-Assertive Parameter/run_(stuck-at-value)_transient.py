...
for j in numpy.arange(11.0, 21.0, 0.5): # Loop for fault injection TIME interval =======================================
    ...
    for i in range(100): # Loop to define how many times to pick random value ===========================================
        ...
        value = random.randrange(1, 1000) # Random number for target faulty parameter===================================
        valueL.append(value)
        ...
        def run():
            ...
            while traci.simulation.getMinExpectedNumber() > 0:
                ...
                if step == (round(j, 3) *10) + 1:
                    traci.vehicle.setParameter('5', "laneChangeModel.lcAssertive", str(1.00))
                step += 1
            traci.close()
            sys.stdout.flush()
